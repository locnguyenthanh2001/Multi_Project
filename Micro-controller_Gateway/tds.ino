...
//LCD's function
void displayLCD(int mode, float value);
...
void displayLCD(int mode, float value){
  lcd.clear();
  lcd.setCursor(0,0);
  if(mode == 0) lcd.print("Sending TDs");
  else if(mode == 1)lcd.print("Sending Humid");
  else lcd.print("Sending Tempt");
  lcd.setCursor(0,1);
  lcd.print(value);
  if(mode == 0)lcd.print("ppm");
  else if(mode == 2)lcd.print("ºC");
}
